...
class RealTimePlot:
    ...
    def __init__(self):
        ...
        self.cal_angle = None
        self.cal_mag = None
        self.cal_status_text = self.fig.text(0.02, 0.98, "Cal: waiting...", transform=self.fig.transFigure,
    ...
    def set_data(self, adc_angle, adc_mag, force_angle, force_mag, diff_frame, total_pressure_sum, force_total_mag,
                 ...
                 fx_cal=None, fy_cal=None, cal_angle=None, cal_mag=None, cal_status=""):
        with self.lock:
            ...
            self.cal_status_text.set_text(cal_status)
